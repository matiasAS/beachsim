...
public class Details extends JPanel{
	...
	public Details(GraphType gt){
		...
		w = new JButton("Weather (in degrees Fahrenheit, 0 - 60) - Click to Test");
		...
		String chosen = "(Individual User)";
		if(Main.resort)
			chosen = "(Ski Resort User)";
		
		title = new JLabel("Input All Fields Below " + chosen);
