...
public class Compute {
	...
	public static JFreeChart getdefaultgraph() {
		...
		return getgraph(Type.LINE, s.numberofweeks, null, "Time Series: Beach Attendance as Weeks Progress", "Week", true, series);
	}
	...
	public static JFreeChart getweatherpref() {
		...
		return getgraph(Type.SCATTER, 60, bars, "Weather Preference\n vs. Beach Attendance", "Weather in Degrees F", false, null);
	}
	...
	private static JFreeChart getgraph(Type type, int num, double[][] bars, String title, String xaxis, boolean haveseries, XYSeries series) {
		if(!haveseries){
			series = new XYSeries("Attendance Rate");
